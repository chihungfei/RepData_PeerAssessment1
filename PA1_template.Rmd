...
The mean and median of daily steps is `r dailyMean` and `r dailyMedian` respectively.
...
There are `r NACount` NAs in data.
...
```
** The new daily mean and median of steps are `r newDailyMean` and `r newDailyMedian` respectively;  
